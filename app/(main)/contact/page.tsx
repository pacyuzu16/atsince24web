              ...
              <div className="col-span-2 p-8 md:p-10">
                ...
                {isSubmitted ? (
                  <div className="text-center py-12">
                    ...
                    <Button
                      className="bg-brand-blue text-white hover:bg-brand-dark px-6 py-2 text-lg"
                  ...
                  <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <Button
                      type="submit"
                      className={cn(
                        "w-full bg-brand-blue text-white hover:bg-brand-dark py-2.5 text-lg font-medium rounded-md",
